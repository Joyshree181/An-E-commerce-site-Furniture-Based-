...
<html lang="en">
	...
	<body>
		...
		<div class="ui grid">
			<div class="ui four wide column" style="background: DodgerBlue; min-height: 100vh;">
			...
			<div class="ui twelve wide column"style="background-image: url(admin.jpeg); min-height: 100vh;">
					...
					<table class="ui celled unstackable table">
						...
						if ($result = $conn->query($query)) {
							...
							while ($row = $result->fetch_assoc()){
								printf("<tr>");
								printf("<td>%s</td> <td>%s</td> <td>%s</td>     <td> <a href='db/delete.php?id=%s'>Delete</a> <a href='edit_form.php?id=%s'>Edit</a> </td>", $ser, $row["Title"], $row["Size"],$row["ID"], $row["ID"]);
								printf("</tr>");
								$ser++;
							}
						}
